...
\journal{SoftwareX}
\date{\today}
\title{Title/Name of your software\\\medskip
\large Subtitle (if any)}
\hypersetup{
 pdfauthor={Gregorio Ambrosio Cestero},
 pdftitle={Title/Name of your software},
 pdfkeywords={relational, data model, api, toolbox, dataset, robotics},
 pdfsubject={Paper for Elsevier SoftwareX Journal},
...
\label{sec:orgd8981ec}

\section*{Current code version}
\label{sec:org636bbe3}
...
\label{sec:org01d3ff4}

Present the major functionalities of the software.

\subsection{Software Functionalities}
\label{sec:orgcb94914}

Present the major functionalities of the software.

\subsection{Sample code snippets analysis (optional)}
\label{sec:org2470e7a}

\section{Illustrative Examples}
\label{sec:orgb55aa79}
...
your .mp4 file at
\emph{\url{http://elsevier-apps.sciverse.com/GadgetVideoPodcastPlayerWeb/verification}}. This
tool will display your video exactly in the same way as it will appear on
ScienceDirect.).

\section{Impact}
\label{sec:orgb78f277}
...
\section{Conclusions}
\label{sec:orgf6a5be3}

Set out the conclusion of this original software publication.

\section{Conflict of Interest}
\label{sec:orgc24cb0b}
